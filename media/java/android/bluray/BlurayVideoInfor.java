...
* Define the some Bluray Video inforamtions for Rockchip's bluray
*
*/
...
public class BlurayVideoInfor implements Parcelable
{
	...
	private BlurayVideoInfor(Parcel in)	
	{		
	...
	public static final Parcelable.Creator<BlurayVideoInfor> CREATOR =            
		new Parcelable.Creator<BlurayVideoInfor>()     	
	{       	
		public BlurayVideoInfor createFromParcel(Parcel in)         	
		{            	
			return new BlurayVideoInfor(in);        	
		}  
		
		public BlurayVideoInfor[] newArray(int size) 		
		{            	
			return new BlurayVideoInfor[size];        	
		}    	
	};		
	...
	public void tostring()
	{
		...
		Log.d("Bluray Video","Code Type = "+code+"("+mCodeType+")");
		Log.d("Bluray Video","Format = "+format+"("+mFormat+")");
		Log.d("Bluray Video","Frame Rate = "+frameRate+"("+mFrameRate+")");
	}
}
